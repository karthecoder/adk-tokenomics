...
description: Access travel recommendations, hotels, guidelines, and tips for New York. Use when user asks about New York.
license: Apache-2.0
metadata:
  author: travel-nexus
  version: "1.0"
---
# New York Travel Skill

## Destination Information
*   **City:** New York
*   **Country Region:** International Zone 5
*   **About:** A prime world city offering premier cultural, dining, and historic landmarks.

## Recommended Hotels
*   **Grand New York Resort:** A 5-star premier hotel with world-class dining, spa, and shuttle service.
*   **New York Heritage Inn:** Boutique hotel located in the historic city center, walking distance to landmarks.
*   **Budget Stay New York:** Affordable clean lodging with high-speed Wi-Fi, perfect for business travelers.
...
## Emergency Contact
*   Call **112** or the local visitor support line at **900-555-004**.
