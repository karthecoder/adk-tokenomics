---
name: athens-travel
description: Access travel recommendations, hotels, guidelines, and tips for Athens. Use when user asks about Athens.
license: Apache-2.0
metadata:
  author: travel-nexus
  version: "1.0"
...
*   **City:** Athens
*   **Country Region:** International Zone 36
*   **About:** A prime world city offering premier cultural, dining, and historic landmarks.

## Recommended Hotels
*   **Grand Athens Resort:** A 5-star premier hotel with world-class dining, spa, and shuttle service.
*   **Athens Heritage Inn:** Boutique hotel located in the historic city center, walking distance to landmarks.
*   **Budget Stay Athens:** Affordable clean lodging with high-speed Wi-Fi, perfect for business travelers.
...
## Emergency Contact
*   Call **112** or the local visitor support line at **900-555-035**.
